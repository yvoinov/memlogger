...
public:
	...
	void processData();
	void printReportTotal();

	MemloggerReport() : m_OutputConsole(true), m_LogFile(DEFAULT_LOG_FILE), m_OutputFile(DEFAULT_OUTPUT_FILE) {}
private:
	/* Globals */
	...
	void fillArrayEntry(const std::string& p_fname, const std::size_t p_value, const long p_timestamp);
